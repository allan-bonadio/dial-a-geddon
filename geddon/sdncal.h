 ...
 * allocate to an int.  [We'll use ints, these days they're all 32 bit- ab]
 *
...
extern void SdnToGregorian(int sdn, int *pYear, int *pMonth, int *pDay);
extern int GregorianToSdn(int year, int month, int day);
extern char *MonthNameShort[13];
extern char *MonthNameLong[13];

/* Julian calendar conversions. */
extern void SdnToJulian(int sdn, int *pYear, int *pMonth, int *pDay);
extern int JulianToSdn(int year, int month, int day);

/* Jewish calendar conversions. */
extern void SdnToJewish(int sdn, int *pYear, int *pMonth, int *pDay);
extern int JewishToSdn(int year, int month, int day);
extern char *JewishMonthName[14];
extern char *JewishMonthHebName[14];

/* French republic calendar conversions. */
void SdnToFrench(int sdn, int *pYear, int *pMonth, int *pDay);
int FrenchToSdn(int inputYear, int inputMonth, int inputDay);
