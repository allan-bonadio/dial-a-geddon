#ifndef SDNCAL_H
#define SDNCAL_H
// Modified slightly to make declarations C++ friendly ab may 24 2011
...
extern "C" void SdnToJewish(int sdn, int *pYear, int *pMonth, int *pDay);
extern "C" int JewishToSdn(int year, int month, int day);
extern char *JewishMonthName[14];
extern char *JewishMonthHebName[14];

/* Day of week conversion.  0=Sunday, 6=Saturday */
extern "C" int DayOfWeek(int sdn);
